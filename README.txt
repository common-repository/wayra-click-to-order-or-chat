...
Tags: whatsapp, whatsapp button, chat to order, click to chat, whatsapp business, whatsapp chat, whatsapp support
...
1. Config your WhatsApp number and floating button settings
1. WooCommerce - Select the global options, and the product options
1. WooCommerce - Select the cart options
1. Floating and product button on Spanish configuration
1. Cart button on Spanish configuration
1. Button on product when Add to Cart button is removed
1. This plugin no affect your PageSpeed results
1. Messages that you recive from the buttons
1. WooCommerce - cart options in Spanish
...
* please create a [new topic](https://wordpress.org/support/plugin/wayra-click-to-order-or-chat/)  

* plugins@wayramarketing.com.ar  

= Give Support =

If you like this plugin and is useful for you, please support us by giving [5 star rating](https://wordpress.org/support/plugin/wayra-click-to-order-or-chat/reviews/#new-post)  
...
= using FTP or similar =
* Delete Wayra-Click-to-Order-or-Chat folder - your setting will not lost.
* unzip Wayra-Click-to-Order-or-Chat file and 
* Upload "Wayra-Click-to-Order-or-Chat" folder to the "/wp-content/plugins/" directory.
* Activate the plugin through the "Plugins" menu in WordPress.
